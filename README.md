...
Android application backup is disabled so app-private WireGuard profiles and diagnostic logs are not exported through Android's backup/restore pipeline.
